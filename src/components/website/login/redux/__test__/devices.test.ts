import { MapAppActionType, MapAppRemoteRequest, mapAppRemoteAnswer } from '../../../mapApp/redux/MapAppAction';
...
describe('devices epic test', () => {
    ...
    it('should get a list of devices', async () => {
        const request: MapAppRemoteRequest = { type: MapAppActionType.REMOTE_REQUEST };
